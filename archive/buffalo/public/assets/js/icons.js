// Icons functionality for AVR website
// Handles dynamic icon rendering and interactions
...
(function() {
    ...
    const icons = {
        ...
        menu: '<svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/></svg>',
    ...
    function renderIcon(iconName, className = '') {
        ...
        if (className) {
            return iconSvg.replace('<svg', `<svg class="${className}"`);
        }
    ...
    function initializeIcons() {
        ...
        iconElements.forEach(element => {
            ...
            const iconHtml = renderIcon(iconName, element.className);
            if (iconHtml) {
