...
## Project-Specific Plush Template Guide

This section provides project conventions for writing and modifying Plush templates in this repository.
...
### Helper and Context Conventions
...
### Verification requirement for agents
